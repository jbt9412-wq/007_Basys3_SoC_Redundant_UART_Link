...
The complete STM32CubeIDE projects used for the final hardware demonstration are stored in the repository root as [`stm_setting.zip`](../../stm_setting.zip).
...
The `.ioc`, `Core/Inc`, `Core/Src`, startup, linker, HAL/CMSIS, and CubeIDE project configuration files are retained in the archive. Generated Debug object files are not the authoritative source.
